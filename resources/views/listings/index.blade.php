    ...
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Apskati svaigākos piedāvājumus – bildes tiek automātiski optimizētas, lai ielāde būtu ātrāka gan uz mobilajām, gan galddatoru ierīcēm.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="space-y-10">
        ...
        @else
            <div class="rounded-3xl border border-dashed border-gray-300 bg-white/70 p-12 text-center shadow-sm">
                ...
                <p class="mt-2 text-sm text-gray-500">Sāc ar pirmo auto – pievieno sludinājumu un augšupielādētās bildes tiks skaisti saglabātas galerijā.</p>
            </div>
        @endif
    </div>
</x-app-layout>
