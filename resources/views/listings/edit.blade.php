@php
    ...
    $carDataElementId = 'car-data-' . uniqid();
@endphp
    ...
    <div class="mx-auto w-full max-w-5xl">
        <div class="space-y-10 rounded-3xl bg-white/80 p-8 shadow-xl ring-1 ring-gray-100 backdrop-blur">
            <script
                ...
                id="{{ $carDataElementId }}"
                class="hidden"
            >{!! json_encode($carData, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_AMP | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) !!}</script>
            ...
            <form
                ...
                class="space-y-10"
                x-data="listingForm('{{ $carDataElementId }}', @json(old('marka', $listing->marka)), @json(old('modelis', $listing->modelis)))"
            >
                @csrf
                @method('PUT')
