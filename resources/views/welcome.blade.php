<x-app-layout>
    ...
    <a href="{{ route('listings.show', $listing->id) }}"
       class="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 text-white text-base font-semibold bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
        Skatīt detaļas
    </a>
</div>
